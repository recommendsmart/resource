...
/**
 * @file
 * Contains \Drupal\resource\Entity\Form\ResourceForm.
 */
...
class ResourceForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        drupal_set_message($this->t('Created the %label Resource.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        drupal_set_message($this->t('Saved the %label Resource.', [
          '%label' => $entity->label(),
        ]));
    }
